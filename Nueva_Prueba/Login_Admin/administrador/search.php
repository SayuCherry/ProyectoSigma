	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles"><i class="zmdi zmdi-search zmdi-hc-fw"></i> BUSCAR USUARIO</h1>
			</div>
			<p class="lead">Centro de busqueda de usuarios</p>
		</div>
		...
		<div class="container-fluid">
			<h2 class="text-titles text-center">Usuario seleccionado</h2>
			<div class="row">
				<div class="col-xs-12">
