...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			...
			<p class="lead">Bienvenido de nuevo a la sección de gestión de usuarios</p>
		</div>

		<div class="container-fluid">
			<ul class="breadcrumb breadcrumb-tabs">
				<li>
					<a href="user.php" class="btn btn-info">
						<i class="zmdi zmdi-plus"></i> &nbsp; NUEVO USUARIO
					</a>
				</li>
				<li>
					<a href="user_list.php" class="btn btn-success">
						<i class="zmdi zmdi-format-list-bulleted"></i> &nbsp; LISTA DE USUARIOS
					</a>
				</li>
				<li>
					<a href="user_search.php" class="btn btn-primary">
