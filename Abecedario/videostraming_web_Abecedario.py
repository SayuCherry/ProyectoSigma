...
def condicionalesLetras(dedos, frame):
    try:
        font = ImageFont.truetype("DINRoundPro.ttf", 70)
    except IOError:
    ...
    incorrect_color = (0, 0, 255)  # Rojo
    color = incorrect_color
    letra_detectada = 'Letra - X'
    ...
    draw.rectangle([rect_start, rect_end], fill=color, outline=(0, 0, 0), width=5)

    # Dibujar borde alrededor del texto
    text_width, text_height = draw.textsize(letra_detectada, font=font)
